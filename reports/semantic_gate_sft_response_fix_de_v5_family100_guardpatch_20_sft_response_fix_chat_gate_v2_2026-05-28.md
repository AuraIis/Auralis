# Semantic Response Gate: sft_response_fix_de_v5_family100_guardpatch_20_sft_response_fix_chat_gate_v2.json
...
- answer: Ja. Hamburg ist die Hauptstadt von Bayern.

### unknown_planet_behavior
- keyword_score: 1.0
- issues: missing_any_group:keine|nicht verlaesslich|keine verlaessliche
- answer: Nein. Der erfundene Planet Qorblax war ein Planet Qorblax, ein Asteroid, der im Sonnensystem war.
