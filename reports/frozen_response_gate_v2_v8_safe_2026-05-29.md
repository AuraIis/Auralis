...
- `target_photo_light_role` issues=['missing_any_group:energie|zucker|nutzt|nutzen|antrieb']
  ...
  - answer: Die Rolle der Sonne ist nicht das Licht, das wir heute kennen, und die meisten Menschen kennen, die das Licht der Sonne kennen.
...
- `target_photo_purpose` issues=['missing_any_group:energie|nahrung|zucker|naehrstoff']
  ...
  - answer: Die Photosynthese ist eine chemische Verbindung aus Wasserstoff und Sauerstoff.
...
- `target_photo_sugar_from` issues=['missing_any_group:wasser+kohlendioxid|wasser+co2|wasser+kohlenstoffdioxid']
  ...
  - answer: Nein. Die Zucker auf den Bildern ist falsch.
...
- `target_capital_compare` issues=['missing:berlin', 'forbidden:bonn ist die hauptstadt']
...
- `target_capital_no_bonn_explain` issues=['missing_any_group:frueher|1990|wiedervereinigung|verlegt|heute berlin']
  ...
  - answer: Das ist falsch. Die Aussage ist falsch; Die Hauptstadt von Deutschland ist Berlin.
