#!/usr/bin/env python3
"""H-v4.1 mix: grounded_v4_1 (=v4 + 4 regression-fix buckets) x2 + grounded_v2 x1
+ grounded_raw x1 + corrective + tool + abstain."""
import json, os, random
from collections import Counter
random.seed(47)
REPO = "/workspace/v2data"; D = REPO + "/data/training"; OUT = D + "/sft_grounded_v4_1"; os.makedirs(OUT, exist_ok=True)
...
rows = []
add_grounded(D + "/sft_grounded/grounded_v4_1.jsonl", 2, "grounded_v4_1")
