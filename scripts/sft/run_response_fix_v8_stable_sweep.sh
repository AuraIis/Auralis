...
python scripts/data/build_sft_response_fix_de_v8_stable_mix.py

for steps in ${STEPS:-10 20 35}; do
  tag="sft_response_fix_de_v8_stable_from_v6_40_${steps}"
...
print("== v8 stable sweep summary ==")
for path in sorted(Path("reports").glob("semantic_gate_sft_response_fix_de_v8_stable_from_v6_40_*_2026-05-28.json")):
