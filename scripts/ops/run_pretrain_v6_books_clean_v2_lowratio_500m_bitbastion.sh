...
python -u scripts/pretrain/train_phase1.py \
  --config configs/training/pretrain_v6_books_clean_v2_lowratio_500m_from_expanded_best_bitbastion.yaml \
  --init-weights /workspace/v2data/checkpoints/pretrain_v6_expanded_test_500m_from_v5_best_bitbastion/best.pt \
  --no-wandb \
  --no-compile
