...
FACT_PROBES = [
    ...
    (
        ...
        " Berlin.",
        [(" Hund.", "easy"), (" Paris.", "med"), (" München.", "hard"), (" Hamburg.", "hard")],
    ),
    (
        "de_cap_fr",
        "de",
        ...
        " Paris.",
        [(" Tisch.", "easy"), (" Rom.", "med"), (" Lyon.", "hard"), (" Marseille.", "hard")],
    ),
    (
        "de_cap_it",
        "de",
        ...
        " Rom.",
        [(" Auto.", "easy"), (" Madrid.", "med"), (" Mailand.", "hard"), (" Neapel.", "hard")],
    ),
    (
        "de_cap_es",
        "de",
        "geo",
        "Die Hauptstadt von Spanien ist",
        " Madrid.",
        [(" Baum.", "easy"), (" Berlin.", "med"), (" Barcelona.", "hard")],
    ),
    (
        "de_cap_at",
        "de",
        ...
        " Wien.",
        [(" Wasser.", "easy"), (" Berlin.", "med"), (" Graz.", "hard"), (" Salzburg.", "hard")],
    ),
    (
        "de_cap_uk",
        "de",
        "geo",
        "Die Hauptstadt des Vereinigten Königreichs ist",
        " London.",
        [(" Brot.", "easy"), (" Berlin.", "med"), (" Manchester.", "hard")],
    ),
    (
        "en_cap_de",
        "en",
        ...
        " Berlin.",
        [(" dog.", "easy"), (" Paris.", "med"), (" Munich.", "hard"), (" Hamburg.", "hard")],
    ),
    (
        "en_cap_jp",
        "en",
        ...
        " Tokyo.",
        [(" table.", "easy"), (" Berlin.", "med"), (" Osaka.", "hard"), (" Kyoto.", "hard")],
    ),
    (
        "en_cap_uk",
        "en",
        ...
        " London.",
        [(" apple.", "easy"), (" Berlin.", "med"), (" Manchester.", "hard")],
    ),
    (
        "en_cap_fr",
        "en",
        ...
        " Paris.",
        [(" car.", "easy"), (" Tokyo.", "med"), (" Lyon.", "hard"), (" Marseille.", "hard")],
    ),
    (
        "en_cap_us",
        "en",
        ...
        " Washington.",
        [(" tree.", "easy"), (" London.", "med"), (" New York.", "hard")],
    ),
    (
        "en_cap_ru",
        "en",
        ...
        " Moscow.",
        [(" bread.", "easy"), (" Paris.", "med"), (" Saint Petersburg.", "hard")],
    ),
    # ---------- Wissenschaft ----------
    (
        "de_gold",
        "de",
        "sci",
        "Das chemische Symbol für Gold ist",
        " Au.",
        [(" Berlin.", "easy"), (" Fe.", "med"), (" Ag.", "hard")],
    ),
    (
        "de_silver",
        "de",
        "sci",
        "Das chemische Symbol für Silber ist",
        " Ag.",
        [(" Haus.", "easy"), (" Fe.", "med"), (" Au.", "hard")],
    ),
    (
        "de_boil",
        "de",
        ...
        " 100 Grad Celsius.",
        [(" blau.", "easy"), (" 0 Grad Celsius.", "med"), (" 90 Grad Celsius.", "hard")],
    ),
    (
        "de_freeze",
        "de",
        ...
        "Wasser gefriert bei",
        " 0 Grad Celsius.",
        [(" Montag.", "easy"), (" 100 Grad Celsius.", "med"), (" 4 Grad Celsius.", "hard")],
    ),
    (
        "de_sun",
        "de",
        ...
        "Die Sonne ist ein",
        " Stern.",
        [(" Tisch.", "easy"), (" Komet.", "med"), (" Planet.", "hard")],
    ),
    (
        "de_center",
        "de",
        "sci",
        "Der Mittelpunkt unseres Sonnensystems ist die",
        " Sonne.",
        [(" Tür.", "easy"), (" Milchstraße.", "med"), (" Erde.", "hard")],
    ),
    (
        "de_h2o",
        "de",
        "sci",
        "Die chemische Formel von Wasser ist",
        " H2O.",
        [(" XY.", "easy"), (" O2.", "med"), (" CO2.", "hard")],
    ),
    (
        "en_gold",
        "en",
    ...
    (
        ...
        " Jupiter.",
        [(" apple.", "easy"), (" Earth.", "med"), (" Saturn.", "hard"), (" Mars.", "hard")],
    ),
    (
        "en_boil",
        "en",
        "sci",
        "Water boils at normal pressure at",
        " 100 degrees Celsius.",
        [(" blue.", "easy"), (" 0 degrees Celsius.", "med"), (" 90 degrees Celsius.", "hard")],
    ),
    (
        "en_h2o",
        "en",
    ...
    (
        ...
        "The Sun is a",
        " star.",
        [(" table.", "easy"), (" comet.", "med"), (" planet.", "hard")],
    ),
    # ---------- Geschichte ----------
    (
        "de_faust",
        "de",
        "hist",
        "Das Drama Faust wurde geschrieben von",
        " Goethe.",
        [(" Auto.", "easy"), (" Brecht.", "med"), (" Schiller.", "hard")],
    ),
    (
        "de_relativ",
        "de",
        "hist",
        "Die Relativitätstheorie stammt von Albert",
        " Einstein.",
        [(" Banane.", "easy"), (" Darwin.", "med"), (" Newton.", "hard")],
    ),
    (
        "de_brd",
        "de",
        "hist",
        "Die Bundesrepublik Deutschland wurde gegründet im Jahr",
        " 1949.",
        [(" Apfel.", "easy"), (" 1789.", "med"), (" 1939.", "hard")],
    ),
    (
        "de_mauer",
        "de",
    ...
    (
        ...
        " 1945.",
        [(" blau.", "easy"), (" 1815.", "med"), (" 1944.", "hard")],
    ),
    (
        "de_columbus",
        "de",
        "hist",
        "Amerika wurde im Jahr 1492 erreicht von",
        " Kolumbus.",
        [(" Tisch.", "easy"), (" Goethe.", "med"), (" Magellan.", "hard")],
    ),
    (
        "en_romeo",
        "en",
        ...
        " Shakespeare.",
        [(" car.", "easy"), (" Chaucer.", "med"), (" Dickens.", "hard")],
    ),
    (
        "en_relativ",
        "en",
        ...
        " Einstein.",
        [(" banana.", "easy"), (" Darwin.", "med"), (" Newton.", "hard")],
    ),
    (
        "en_moon",
        "en",
        "hist",
        "The first moon landing happened in the year",
        " 1969.",
        [(" dog.", "easy"), (" 1869.", "med"), (" 1979.", "hard")],
    ),
    (
        "en_ww2",
        "en",
        ...
        " 1945.",
        [(" blue.", "easy"), (" 1815.", "med"), (" 1944.", "hard")],
    ),
    (
        "en_indep",
        "en",
        "hist",
        "The United States declared independence in the year",
        " 1776.",
        [(" apple.", "easy"), (" 1492.", "med"), (" 1789.", "hard")],
    ),
    (
        "en_gravity",
        "en",
        "hist",
        "The law of gravitation is associated with Isaac",
        " Newton.",
        [(" table.", "easy"), (" Darwin.", "med"), (" Einstein.", "hard")],
    ),
    # ---------- Sprache / Übersetzung ----------
    (
        "de2en_dog",
        "de",
        "lang",
        "Das englische Wort für Hund ist",
        " dog.",
        [(" Tisch.", "easy"), (" bird.", "med"), (" cat.", "hard")],
    ),
    (
        "de2en_cat",
        "de",
        "lang",
        "Das englische Wort für Katze ist",
        " cat.",
        [(" blau.", "easy"), (" fish.", "med"), (" dog.", "hard")],
    ),
    (
        "de2en_house",
        "de",
        "lang",
        "Das englische Wort für Haus ist",
        " house.",
        [(" Montag.", "easy"), (" car.", "med"), (" home.", "hard")],
    ),
    (
        "de2en_water",
        "de",
        "lang",
        "Das englische Wort für Wasser ist",
        " water.",
        [(" Auto.", "easy"), (" bread.", "med"), (" fire.", "hard")],
    ),
    (
        "de2en_red",
        "de",
        "lang",
        "Das englische Wort für rot ist",
        " red.",
        [(" Stuhl.", "easy"), (" green.", "med"), (" blue.", "hard")],
    ),
    (
        "de2en_sun",
        "de",
        "lang",
        "Das englische Wort für Sonne ist",
        " sun.",
        [(" Apfel.", "easy"), (" star.", "med"), (" moon.", "hard")],
    ),
    (
        "en2de_water",
        "en",
        ...
        " Wasser.",
        [(" dog.", "easy"), (" Brot.", "med"), (" Feuer.", "hard")],
    ),
    (
        "en2de_house",
        "en",
        "lang",
        "The German word for house is",
        " Haus.",
        [(" blue.", "easy"), (" Baum.", "med"), (" Wohnung.", "hard")],
    ),
    (
        "en2de_dog",
        "en",
        ...
        " Hund.",
        [(" table.", "easy"), (" Vogel.", "med"), (" Katze.", "hard")],
    ),
    (
        "en2de_red",
        "en",
        "lang",
        "The German word for red is",
        " rot.",
        [(" car.", "easy"), (" grün.", "med"), (" blau.", "hard")],
    ),
    (
        "en2de_book",
        "en",
        "lang",
        "The German word for book is",
        " Buch.",
        [(" apple.", "easy"), (" Tisch.", "med"), (" Heft.", "hard")],
    ),
    ...
    (
        ...
        "en",
        "tech",
        "In Python, to print text to the console you use the function",
        " print().",
        [(" banana.", "easy"), (" open().", "med"), (" println().", "hard")],
    ),
    (
        "tech_comment",
        "en",
    ...
    (
        ...
        "en",
        "tech",
        "JSON stores data as collections of key-value",
        " pairs.",
        [(" apples.", "easy"), (" rows.", "med"), (" tables.", "hard")],
    ),
    (
        "tech_list",
        "en",
        "tech",
        "In Python, an empty list is written as",
        " [].",
        [(" XX.", "easy"), (" ().", "med"), (" {}.", "hard")],
    ),
    (
        ...
        "en",
        "tech",
        "Web pages are written in the markup language",
        " HTML.",
        [(" banana.", "easy"), (" Python.", "med"), (" XML.", "hard")],
    ),
    (
        "tech_https",
        "en",
        "tech",
        "A secure website uses the protocol",
        " HTTPS.",
        [(" dog.", "easy"), (" FTP.", "med"), (" HTTP.", "hard")],
    ),
    (
        "tech_var",
        "en",
        "tech",
        "In programming, a named value that can change is called a",
        " variable.",
        [(" table.", "easy"), (" color.", "med"), (" constant.", "hard")],
    ),
    (
        "tech_bit",
        "en",
        "tech",
        "The smallest unit of digital information is the",
        " bit.",
        [(" apple.", "easy"), (" meter.", "med"), (" byte.", "hard")],
    ),
    (
        "tech_loop",
        "en",
        "tech",
        "In programming, code that repeats is called a",
        " loop.",
        [(" banana.", "easy"), (" door.", "med"), (" function.", "hard")],
    ),
    (
        "tech_sql",
        "en",
        "tech",
        "Relational databases are queried with the language",
        " SQL.",
        [(" car.", "easy"), (" English.", "med"), (" Python.", "hard")],
    ),
]
...
def continuation_nll(model, sp, device, prompt, continuation):
    ...
    losses = [
        float(-logp[pos - 1, int(y[pos - 1])].item())
...
def main() -> None:
    ...
    for pid, lang, cat, prompt, correct, dists in FACT_PROBES:
        ...
        rank, hit = (
            topk_hit(model, sp, device, prompt, first_c, args.topk)
        ...
        rows.append(
            {
                ...
                "per_hardness": per_h,
                "strict_ok": per_h[hardest]["ok"] if hardest else False,
                "strict_level": hardest,
                "topk_rank": rank,
                "topk_hit": bool(hit),
            }
        )
    ...
    print(
        f"{'category':10s}{'strict':>8s}{'easy':>8s}{'med':>8s}{'hard':>8s}{'top' + str(args.topk):>8s}"
    )
    cat_out = {}
    for c in cats:
    ...
    print("-" * 50)
    ov_e = acc_at(rows, "easy")
    ov_m = acc_at(rows, "med")
    ov_h = acc_at(rows, "hard")
    print(
        f"{'OVERALL':10s}{strict_acc(rows) * 100:7.0f}%{ov_e[0] * 100:7.0f}%{ov_m[0] * 100:7.0f}%{ov_h[0] * 100:7.0f}%"
