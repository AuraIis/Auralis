...
from code_format import tab_indent, TAB_WIDTH  # noqa: F401  (shared transform; re-exported)
...
def main():
    ...
    ap.add_argument("--tab-indent", action="store_true",
